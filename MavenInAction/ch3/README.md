...
* eclipse添加MarkDown和Subversion插件,从eclipse marketPlaces
...
### 1.2.3 eclipse git配置
* 打开eclipse, 设置ssh2, 选择 ~/.ssh的绝对路径
		Window > Preferences > General > Network Connections > SSH2
		
### 1.4 集成使用
* github.com 创建源码库,并拷贝地址
* eclipse 的 git 视图 clone 刚刚的地址, 让他指向本地某个文件夹
* eclipse中创建maven工程存放于git刚clone出来的目录, 然后就用可以类似svn进行版本处理了

## 2.maven helloworld 工程练习
### 2.1 前提
* 需要先使用eclipse从github迁出一个源码库至本地
		
### 2.2 创建工程
* 新建maven-archetype-quickstart工程, 项目存放于2.1迁出的本地路径
* 执行maven test
		
### 2.3 git提交测试
* 验证提交,合并,回滚等操作
		
## 3.GitHub MarkDown语法练习		
				
<h1/>
注: 以下是github markdown语法的存档
===================================
大标题
===================================
